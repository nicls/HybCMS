...
try { //configure page
    ...
    /* Page Setup
      ================================================= */
    $hcms->setupPage('title', array('title' => 'Plugin Social Media Buttons', 'prepend' => ' - clarotool.de'));
    ...
    $objSMB = new HybridCMS\Plugins\Smb\Smb(HYB_CURRURL, 'Soicla Media Button Plugin');
    $hcms->loadPlugin($objSMB);
    ...
    <div class="row">
        <article class="col-xs-12 col-md-7" id="mainContent">
            ...
            <div class="hyb-rd" hyb-rd-section="familie">
                ...
                <?php
                    if(true === isset($objSMB))
                    {
                        $objSMB->setTotalShares(true);
                        echo $objSMB->toString();
                    }
                ?>
