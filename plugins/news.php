...
try { //configure page
    ...
    /* Page Setup
      ================================================= */
    $hcms->setupPage('title', array('title' => 'Plugin News', 'prepend' => ' - clarotool.de'));
    ...
    $arrParams = array('numberOfResults' => 5);
    $objWidgetNews = new \HybridCMS\AsideWidgets
            \WidgetNews('news', 'sidebar', 2, $arrParams);
    $hcms->addAsideWidget($objWidgetNews);    
} 
catch (\Exception $e) 
{
    //Log Error
...
<div class="container">
    <div class="row">
        <article class="col-xs-12 col-md-7" id="mainContent">
            <h1>Soicla Media Button Plugin</h1>
            <div class="hyb-rd" hyb-rd-section="familie">
                
                <?php
                    if(true === isset($objNews))
                    {
                        echo $objNews->toString();
                    }
                ?>
