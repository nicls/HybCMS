 ...
 */
class HeroShotSchriftenKaufen extends \HybridCMS\Plugins\HeroShot\HeroShot {
    
    private $bgImg = 'bg-schriften-kaufen-heroshot-1200x423.png';
    ...
    public function toString($args = array()) {
        ...
        //background image
        $op .= '<img src="' . HYB_PLUGINPATH . 'HeroShot/images/' . $this->bgImg . '" alt="Verkäuferin von Schriften" />';
        ...
        //button
        $op .= '<a href="'. htmlspecialchars($this->url) .'" target="_blank" title="Schriften kaufen" class="bgLinotypeRed button" rel="nofollow">' . htmlspecialchars($this->buttonText) . '</a>';
