...
/**
 * class HeroShotSchriftenTesten
 *
 * @package HeroShot
 * @author Claas Kalwa
 * @copyright 2013 Claroweb.de
 */
class HeroShotSchriftenTesten extends \HybridCMS\Plugins\HeroShot\HeroShot {
    
    private $bgImg = 'bg-schriften-testen-heroshot-1200x423.jpg';
    ...
    public function __construct($headline, $arrListItems, $buttonText, $url) {
        ...
        try {
            ...
            $objCSSResource = new \HybridCMS\Page\Resources\CSSResource(
                    'heroShot', //1
                    '/HybridCMS/Plugins/HeroShot/css/HSschriftenKaufen.css', //2
                    4, //3
                    false, //4
                    true //5
                    );
    ...
    public function toString($args = array()) {
        ...
        //background image
        $op .= '<img src="' . HYB_PLUGINPATH . 'HeroShot/images/' . $this->bgImg . '" alt="Verkäuferin" />';
        ...
        //button
        $op .= '<a href="'. htmlspecialchars($this->url) .'" target="_blank" title="Schriften testen" class="bgLinotypeRed button" rel="nofollow">' . htmlspecialchars($this->buttonText) . '</a>';
