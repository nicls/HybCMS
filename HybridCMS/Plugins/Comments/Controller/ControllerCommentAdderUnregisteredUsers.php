...
/**
 * class handles all requests to add a new Comment
 * submitted by unregistered user
 *
 * @package Plugins/User/Controller
 * @author Claas Kalwa
 * @copyright 2014 Claroweb.de
 */
class ControllerCommentAdderUnregisteredUsers extends 
...
{    
    ...
    /**
     * Comment submitted by the client
     * @var Comemnt $objComment
     */
    private $objComment;  
