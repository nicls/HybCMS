...
namespace HybridCMS\Plugins\Comments\Admin\AjaxController;

/**
 * class AjaxControllerComments - Handles API-Requests from the admin
    ...
    private function selectCommentsByUrl()
    {
        ...
        try {
            ...
            foreach($arrObjComments as &$objComment)
            {
                ...
                $arrJsonData[] = array(
                    'commentId' => htmlentities($objComment->getCommendId(), 
                            ENT_QUOTES, 'UTF-8'),
                    'url' => htmlentities($objComment->getUrl(), 
                            ENT_QUOTES, 'UTF-8'),
                    'comment' => htmlentities($objComment->getComment(),
                            ENT_QUOTES, 'UTF-8'),
