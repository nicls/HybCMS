...
/**
 * class FooterShotSchriftenTesten
 *
 * @package FooterShot
 * @author Claas Kalwa
 * @copyright 2013 Claroweb.de
 */
class FooterShotSchriftenTesten extends \HybridCMS\Plugins\FooterShot\FooterShot {

    /**
     * attrubutes
     */
    private $img = 'bg-schriften-testen-footerShot-660x337.jpg';
    ...
    public function toString($args = array()) {
        ...
        //button
        $op .= '<a href="'. htmlentities($this->url) .'" target="_blank" title="Schriften testen" class="bgLinotypeRed button" rel="nofollow">' . htmlspecialchars($this->buttonText) . '</a>';
