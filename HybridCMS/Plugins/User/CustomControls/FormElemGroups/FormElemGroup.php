...
class FormElemGroup {
    ...
    protected function registerObserver($objFormStateObserver)
    {
        if(false === ($objFormStateObserver instanceof
                 \HybridCMS\Plugins\User\CustomControls\FormStateObserver))
        {
            throw new \InvalidArgumentException(
            'Error Processing Request:
                    setObjFormStateObservfeedbackStateer(),                    
                    $objFormStateObserver is not an instance of FormStateObserver.', 1);
        }
    ...
    public function setObjContent($objContent) 
    {
                    ...
                    \FormElemGroupContent))
        {
            ...
            'Error Processing Request:
                    setObjContent(),                    
                    $objContent is not an instance of FormElemGroupContent.', 1);
        }
