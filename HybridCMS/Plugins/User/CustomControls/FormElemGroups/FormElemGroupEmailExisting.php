...
/**
 * class FormElemGroupEmailExisting is the concrete implemenatation for an form 
 * Input-Field for a Email of an existing user
 *
 * @package CustomControls
 * @author Claas Kalwa
 * @copyright 2014 Claroweb.de
 */
class FormElemGroupEmailExisting 
