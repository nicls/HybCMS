 ...
 */
class WidgetLatestArticles extends AsideWidget {
    ...
    public function __construct($widgetName, $positionName, $priority, $arrParams) {
        ...
        try {
            ...
            $this->arrArticles = $dbSection->selectLatestNArticlesByCategory($db, $this->catName, $this->numberOfResults);
    ...
    public function toString($args = array()) {
        ...
        foreach ($this->arrArticles as $article) {          
            ...
            $op .= "<p>" . htmlspecialchars($article->getDescription()) . "</p>";
