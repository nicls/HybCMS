...
try { //configure page
    ...
    $arrParams['dataAttr'] = array(
        'data-cm-boxid-ref' => 
        'box-vorteile-blitzlicht box-nachteile-blitzlicht box-nachteile-mobile',
        'data-anotherattr' => 'anotherval'
    );
    ...
    //Widget Flattr Button
    $arrParams = array('text' => 'Bitte spenden: BUTTON',                        
                       'url' => "http://hybcms.vs");
    $objWidgetFlattr = new \HybridCMS\AsideWidgets
            \WidgetFlattr('flattr', 'sidebar', 3, $arrParams);
    $hcms->addAsideWidget($objWidgetFlattr);     
