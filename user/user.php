...
try { //configure page
    ...
    /* Page Setup
      ================================================= */
    $hcms->setupPage('title', array('title' => 'Userprofil', 'prepend' => ' - clarotool.de'));
    ...
    $arrParams = $_GET;  
    $objControllerPublicUserProfile =
            \HybridCMS\Plugins\User\Controller\ControllerFactory::create(
                    'ControllerPublicUserProfile', $arrParams);
    
    assert(false === empty($objControllerPublicUserProfile));
    
    $hcms->loadPlugin($objControllerPublicUserProfile);
...
<div class="container">
    <section class="row" id="mainContent" itemprop="mainContentOfPage">
        <div class="col-xs-12 col-md-7">
            ...
            <?php
                if(false === empty($objControllerPublicUserProfile))
                {
                    echo $objControllerPublicUserProfile->toString();
                }
            ?>
